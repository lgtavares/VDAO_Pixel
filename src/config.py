# This is a configuration file intended to store the most used variables of this project
import torch
import torchvision.transforms as transforms
from src import VDAO_FRAMES_SHAPE

# Correspondence object index
idx2object   = {1: 'dark-blue box',
                2: 'shoe',
                3: 'camera box',
                4: 'towel',
                5: 'white jar',
...
fold2videos  = {'training':{'1':[1, 2, 10, 36, 37, 57, 60],
                '2':[3, 8, 9, 33, 34, 35],
                '3':[4, 11, 12, 38, 39, 40],
                '4':[5, 22, 23, 47, 48, 49],
                '5':[6, 13, 14, 15, 41],
...
idx2tarname  = {1: 'obj-sing-amb-part01-video06.avi',
...
index2refname ={1: 'ref-sing-amb-part01-video01.avi',
...
# torch transforms
resize_transform_half    = transforms.Resize((VDAO_FRAMES_SHAPE[0]//2, VDAO_FRAMES_SHAPE[1]//2))
resize_transform_quarter = transforms.Resize((VDAO_FRAMES_SHAPE[0]//4, VDAO_FRAMES_SHAPE[1]//4))
to_tensor_transform      = transforms.ToTensor()

# Composed transformations
transformations_half    = transforms.Compose([resize_transform_half, to_tensor_transform])
transformations_quarter = transforms.Compose([resize_transform_quarter, to_tensor_transform])
