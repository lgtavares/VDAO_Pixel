/*
 * localizaDummy03Lib.h
 *
 *      Author: gustavo.carvalho
 */

#ifndef LOCALIZADUMMY03LIB_H_
#define LOCALIZADUMMY03LIB_H_
...
void normalizeIllum(const cv::Mat &matSrc, cv::Mat &matDst, const cv::Mat &matMsk);

void normalizeMeanVar(const cv::Mat &matSrc, cv::Mat &matDst, const cv::Mat &matMsk);

void normalizeImage(const cv::Mat &matSrc, cv::Mat &matDst, const cv::Mat &matMsk);

#endif /* LOCALIZADUMMY03LIB_H_ */
